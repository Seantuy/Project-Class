...
author: "Sean Paolo,Ethan Gandiboyina,Daniel Mon,Nhi Nguyen"
date: "2024-05-31"
output:
  pdf_document: 
...
```{r echo=T, eval=T, out.width="65%", out.height="65%",fig.align='center',warning=FALSE}
...
```{r echo=T, eval=T,warning=FALSE, out.width="65%", out.height="65%",fig.align='center'}
...
```
```{r, out.width="65%", out.height="65%",fig.align='center',warning=FALSE}
...
```{r Linear Regression MP, out.width="65%", out.height="65%",fig.align='center',warning=FALSE}
...
```{r Ki Square, out.width="65%", out.height="65%",fig.align='center',warning=FALSE}
...
```{r method, out.width="65%", out.height="65%",fig.align='center',warning=FALSE}
...
#we had done it the normal way but there was a problem with the knitting and we had to debug using chatgpt
# Set CRAN mirror
options(repos = c(CRAN = "https://cran.r-project.org"))

# List of packages to be installed
packages <- c("ggplot2", "ggridges", "corrr", "FactoMineR", "ggcorrplot", "factoextra")
...
```{r, message=FALSE, out.width="65%", out.height="65%",fig.align='center',fig.align='center'}
